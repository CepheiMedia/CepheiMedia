...
const djs = [
  {
    ...
    name: "Romi Lux",
    role: "DJ / Producer",
    image: "/images/dj-romilux.webp",
    gallery: ["/images/dj-romilux.webp"],
    bio: "Romi Lux, originally from Prague, Czech Republic, is an international DJ and producer based in Miami, FL known for her musical talent and energy behind the decks. With more than 150 shows a year, she gained audiences across the globe, holding down residencies spanning from Miami to Europe. Her style is influenced by Electronic Dance and House music but her extensive music knowledge and skills allow her to read any crowd of any size. When not performing, Romi Lux focuses on producing music and hosting her monthly mix show Sundance Sessions. She has released several original tracks and remixes on labels such as Armada, Spinnin', and Darklight Recordings that were supported by major artists like Martin Garrix, Nicky Romero, Fedde Le Grand, Timmy Trumpet, Morgan Page, and many more.",
    highlights: [
      "150+ shows per year worldwide",
      "Residencies spanning Miami to Europe",
      "Performed in Miami, Las Vegas, New York, Chicago, Prague, Ibiza, Croatia, Bahamas, Amsterdam & more",
      "Miami Music Week, Art Basel, ADE in Amsterdam",
      "Shared the stage with Above & Beyond, Kaskade, Zedd, John Summit, Don Diablo, Steve Aoki, Snoop Dogg, Laidback Luke, Sofi Tucker & more",
      "Releases on Armada, Spinnin', Darklight Recordings",
      "Supported by Martin Garrix, Nicky Romero, Fedde Le Grand, Timmy Trumpet, Morgan Page",
      "Host of Sundance Sessions monthly mix show",
    ],
    topTracks: [
